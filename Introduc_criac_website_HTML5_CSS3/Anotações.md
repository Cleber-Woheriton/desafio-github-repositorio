...
| Elemento HTML       | Função         |
| ------------------- | -------------- |
| <h1 class="titulo"> | Abrindo a tag  |
| Título              | Conteúdo       |
| </h1>               | Fechando a tag |
...
<a href="maito:lucas@vilaboim.com">E-mail</a>
```
...
Percebam que podemos colocar vários seletores em uma regra separando-os por vírgula. Exemplo;
...
ID: é representado pelo símbolo # (hash) seguido de um nome para esse ID. Exemplo:
...
Classe: a classe é representada de forma parecida do ID, mas é precedida por um ponto em vez do hash. Exemplo:
...
- As bordas (border)  elas se fundem ao padding e o conteúdo;
